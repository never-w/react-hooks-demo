...
const UseImperativeHandlerDemo = () => {
  ...
  return (
      <div className="text-center">
        <p>The example code is based on the example from official doc</p><br/>
        ...
        <p>Basically, there is few situation where you need to use userImperativeHandler.<br/>
          ...
          <a href="https://www.youtube.com/watch?v=HxY7SzIN44o">https://www.youtube.com/watch?v=HxY7SzIN44o</a>
        </p>
      </div>
  );
};
